...
class AdminRestaurant(models.Model):
...
class foods_list(models.Model):
    name_food=models.CharField(max_length=30)
    price_foo=models.IntegerField(default=0)
    def api(self):
        return {
        "name_food": self.name_food,
        "price_foo": self.price_foo
    }

class Food_reseved(models.Model):
    food_name=models.CharField(max_length=20)
    food_price= models.IntegerField(default=0)
    food_code= models.IntegerField(default=0)
    time_reserve=models.CharField(max_length=20,default=timezone.now)
    ...
    def api(self):
        ...
        "time_reserve":self.time_reserve}
...
#
#     # this function use for make a dictinary for us from the model
#     def api(self):
#         return {
#             "code": self.code,
#             "name": self.name,
