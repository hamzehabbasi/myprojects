...
#
#             self.stdout.write(self.style.SUCCESS(f"Export Saved into {uri}."))
#
...
#         if "Verify Input":
#             if "Find by Mobile":
#                 customer = User.find_user(customer_id)
#
#             if not customer and "Find by PK":
#                 customer = User.i(customer_id)
#
#             if not customer and "Find by Key":
#                 customer = User.k(customer_id)
#
#             if not customer:
#                 self.stdout.write(self.style.NOTICE(f"Business {customer_id} does not exists"))
#                 return
#
...
#                 usage_ids += [x.id for x in Usage.f(request__headers__HTTP_API_KEY=device.ui_token)]
#
...
#             self.stdout.write(self.style.SUCCESS(f"Export Saved into {uri}."))
#
#     def export_customer_usage(self, customer_id):
#         if "Verify Input":
#             if "Find by Mobile":
#                 customer = User.find_user(customer_id)
#
...
#                 return
#
#         self.stdout.write(self.style.SUCCESS(f'Exporting usage data of {customer.username} ({customer.id})...'))
#
#         if "Prepare Usages":
#             usage_ids = []
#             for device in customer.devices.all():
...
#             if not business:
#                 self.stdout.write(self.style.NOTICE(f"Business {business_id} does not exists"))
#                 return
#
